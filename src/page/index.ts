...
export default class Index {
  ...
  public registerBackgroundChangeEvent() {
    ...
    const backgroundLoopSize = (dongmao.getThemeConfig("random_image", "rimage_cover_back_num", Number) || 0).valueOf();
  ...
  public registerBackgroundVideo() {
    ...
    videoPlayButtonElement?.addEventListener("click", async () => {
      videoStatusElement.innerHTML = dongmao.translate("home.video.loading", "正在载入视频 ...");
      ...
      import("video.js")
        .then((module: any) => {
          ...
          videoPlayer = module.default(videoContainerElement.querySelector("video"), {
            ...
            sources: [
              {
                src: dongmao.getThemeConfig("mainScreen", "bgvideo_url", String)?.toString(),
              },
            ],
          });
          ...
          videoPlayer.on("pause", () => {
            videoStatusElement.innerHTML = dongmao.translate("home.video.statu_pause", "已暂停 ...");
            videoStatusElement.style.bottom = "0";
          ...
          videoPlayer.on("waiting", () => {
            videoStatusElement.innerHTML = dongmao.translate("home.video.statu_waiting", "加载中 ...");
            videoStatusElement.style.bottom = "0";
          });
          ...
          videoPlayer.on("error", () => {
            videoStatusElement.innerHTML = dongmao.translate("home.video.statu_error", "视频播放错误");
            setTimeout(() => {
              focusInfoElement.style.top = "0";
              homeWaveElement.style.bottom = "0";
              videoStatusElement.style.bottom = "-100px";
        ...
        .catch((error) => {
          console.error(error);
          videoStatusElement.innerHTML = dongmao.translate("home.video.statu_error", "视频加载失败");
          videoStatusElement.style.bottom = "0";
